...
$query=mysqli_query($conn,"INSERT INTO sub_course(courseid,sub_course) values ('$cname','$subname')");

  $_SESSION['msg']="Category of Course Add Created !!";
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                 ...
                                 <option value="">-- Please select --</option>
                                    <?php $query=mysqli_query($conn,"select * from courses");
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="sub_course" class="form-control" placeholder="Enter your  Category of Course" required="">
